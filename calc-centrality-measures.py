...
sever_universities_name_list = ["Beihang University", "Beijing Institute of Technology", "Harbin Engineering University", "Northwestern Polytechnical University", "Nanjing University of Science & Technology", "Nanjing University of Aeronautics & Astronautics", "Harbin Institute of Technology"]
...
# sever_universities_name_list = ['Beijing University of Technology','University of Houston']
sever_universities_id_list = [node_id for node_id, node_label in G.nodes(data='Label') if node_label in sever_universities_name_list]
top_count = 50
